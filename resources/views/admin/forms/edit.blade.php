...
<div class="px-4 sm:px-0 max-w-3xl">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold tracking-tight text-slate-900 mt-3">Modifier le formulaire</h1>
        <p class="mt-1 text-sm text-slate-500">Mettez à jour les informations de « {{ $form->title }} »</p>
    </div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full px-4 py-2.5 border border-slate-300 rounded-xl text-sm text-slate-900 placeholder-slate-400 focus-visible:ring-2 focus-visible:ring-brand-500/40 focus-visible:border-brand-500 transition-colors duration-150">{{ old('description', $form->description) }}</textarea>
                </div>
            </div>
        </section>
