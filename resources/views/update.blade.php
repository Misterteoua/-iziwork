...
<body>
    <div class="card">
        ...
        @elseif(!empty($pending) && $dbOk)
            {{-- Migrations en attente --}}
            <div class="pending">
                <h2>📋 {{ count($pending) }} migration(s) en attente</h2>
                <ul>
        ...
        @else
            <div class="success">
                ...
                <p style="font-size:.875rem;">Aucune migration en attente. Le code et la base sont synchronisés.</p>
            </div>
        @endif
